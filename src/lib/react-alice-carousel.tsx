...
export default class MyCarousel extends React.PureComponent<Props, State> {
  ...
  constructor(props: Props) {
    ...
    [this._handleResizeDebounced, this._cancelResizeDebounced] = Utils.debounce(
      this._handleResize,
      100
    );
  }
  ...
  get isFadeoutAnimationAllowed() {
    ...
    return (
      ...
      !(paddingLeft || paddingRight || autoWidth)
    );
  }
  ...
  render() {
    ...
    const shouldDisableButtons = Utils.shouldDisableButtons(
      this.props,
      this.state
    );
    ...
    const classnameModifier =
      this.props.ssrSilentMode || canUseDom ? "" : Modifiers.SSR;
