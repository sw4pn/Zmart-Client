...
const data = {
  ...
  content: `
    ...
    <p>
      Welcome to <b>ZMart LLC</b> (“Company”, “we”, “our”, “us”)!
    </p>
    <p>
      These Terms of Service (“Terms”, “Terms of Service”) govern your use of
      our website located at <b>zcom.web</b> (together or individually
      “Service”) operated by <b>ZCOM LLC</b>.
    </p>
    <p>
    ...
    <p>
      ...
      not use the Service, but please let us know by emailing a
      <b>support@zcom.web</b> so we can try to find a solution. These Terms
    ...
    <p>
      ...
      following the unsubscribe link or by emailing at support@zcom.web.
    </p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">
      3. Purchases
    </h4>
    ...
    <p>
      ...
      renew under the exact same conditions unless you cancel it or ZCOM LLC
      cancels it. You may cancel your Subscription renewal either through your
      online account management page or by contacting support@zcom.web customer
      support team.
    </p>
    <p>
      A valid payment method is required to process the payment for your
      subscription. You shall provide ZCOM LLC with accurate and complete
      ...
      automatically authorize ZCOM LLC to charge all Subscription fees incurred
      through your account to any such payment instruments.
    </p>
    <p>
      Should automatic billing fail to occur for any reason, ZCOM LLC reserves
    ...
    <p>
      ZCOM LLC may, at its sole discretion, offer a Subscription with a free
    ...
    <p>
      ...
      you will not be charged by ZCOM LLC until Free Trial has expired. On the
    ...
    <p>
      At any time and without notice, ZCOM LLC reserves the right to (i) modify
    ...
    <p>
      ZCOM LLC, in its sole discretion and at any time, may modify Subscription
      fees for the Subscriptions. Any Subscription fee change will become
      effective at the end of the then-current Billing Cycle.
    </p>
    <p>
      ZCOM LLC will provide you with a reasonable prior notice of any change in
    ...
    <p>
      ZCOM LLC has the right but not the obligation to monitor and edit all
      Content provided by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of
      ZCOM LLC or used with permission. You may not distribute, modify,
    ...
    <li class="py-1">
    0.8. Take any action that may damage or falsify Company rating.</li>
    <li class="py-1">
    ...
    <p>
      ...
      ZCOM LLC and its licensors. Service is protected by copyright, trademark,
    ...
    <p>
      ...
      support@zcom.web, with the subject line: “Copyright Infringement” and
    ...
    <li class="py-1">0.4. your address, telephone number, and email address;
    </li>
  <li class="py-1">
    ...
    <p>You can contact our Copyright Agent via email at support@zcom.web.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">
      17. Error Reporting and Feedback
    </h4>
    <p>
      You may provide us either directly at support@zcom.web or via third party
    ...
    <p>
      ...
      are not owned or controlled by ZCOM LLC.
    </p>
    <p>
      ZMart LLC has no control over, and assumes no responsibility for the
    ...
    <p style="margin-top: 5em; font-size: 0.7em;">
      ...
      were created for <b>zcom.web</b> by
      <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-01-26.
    </p>
  </>`,
};
