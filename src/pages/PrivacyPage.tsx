...
const data = {
  ...
  content: `
    ...
    <p>Welcome to <b> ZCOM LLC</b>.</p>
    <p><b>ZCOM LLC</b> (“us”, “we”, or “our”) operates <b>zcom.co</b> (hereinafter referred to as <b>“Service”</b>).</p>
    <p>Our Privacy Policy governs your visit to <b>zcom.co</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">
    2. Definitions</h4>
    <p><b>SERVICE</b> means the zcom.co website operated by ZCOM LLC.</p>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">3. Information Collection and Use.</h4>
    <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">4. Types of Data Collected</h4>
    ...
    <p>This Usage Data may include information such as your computer@apos;s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">5. Use of Data</h4>
    <p>ZCOM LLC uses the collected data for various purposes:</p>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">6. Retention of Data</h4>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">7. Transfer of Data</h4>
    <p>Your information, including Personal Data, may be transferred to - and maintained on - computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.</p>
    <p>If you are located outside Cloud and choose to provide information to us, please note that we transfer the data, including Personal Data, to Cloud and process it there.</p>
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
    <p>ZCOM LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">8. Disclosure of Data</h4>
    <p>We may disclose personal information that we collect, or you provide:</p>
    <p>0.1.Disclosure for Law Enforcement.</b></p><p>Under certain circumstances, we may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities.</p><p>0.2.Business Transaction.</p><p>If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.</p><p>0.3. Other cases. We may disclose your information also:</p><p>0.3.1. to our subsidiaries and affiliates;</p><p>0.3.2. to contractors, service providers, and other third parties we use to support our business;</p><p>0.3.3. to fulfill the purpose for which you provide it;</p><p>0.3.4. for the purpose of including your company's logo on our website;</p><p>0.3.5. for any other purpose disclosed by us when you provide the information;</p><p>0.3.6. with your consent in any other cases;</p><p>0.3.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">9.Security of Data</h4>
    <p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)
    </h4>
    <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
    <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>support@zcom.web</b>.</p>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h4>
    ...
    <p>0.4. users are able to change their personal information by emailing us at <b>support@zcom.web</b>.</p>
    <p>Our Policy on “Do Not Track” Signals:</p>
    <p>We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked.</p>
    <p>You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h4>
    <p>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:</p>
    <p class="font-semibold py-1">0.1. What personal information we have about you. If you make this request, we will return to you:</p>
    ...
    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>support@zcom.web</b>.</p>
    <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">13. Service Providers</h4>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">14. Analytics</h4>
    <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">15. CI/CD tools</h4>
    <p>We may use third-party Service Providers to automate the development process of our Service.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">16. Advertising</h4><p>We may use third-party Service Providers to show advertisements to you to help support and maintain our Service.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">17. Behavioral Remarketing</h4>
    <p>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">18. Payments</h4><p>We may provide paid products and/or services within Service. In that case, we use third-party services for payment processing (e.g. payment processors).</p><p>We will not store or collect your payment card details. That information is provided directly to our third-party payment processors whose use of your personal information is governed by their Privacy Policy. These payment processors adhere to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, Mastercard, American Express and Discover. PCI-DSS requirements help ensure the secure handling of payment information.</p>
    
    <h4 class="mt-6 mb-3 font-semibold text-lg">19. Links to Other Sites</h4>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">20. Children's Privacy</h4>
    ...
    <h4 class="mt-6 mb-3 font-semibold text-lg">21. Changes to This Privacy Policy</h4>
    <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
    <p>We will let you know via email and/or a prominent notice on our Service, prior to the change becoming effective and update “effective date” at the top of this Privacy Policy.</p>
    <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
    <h4 class="mt-6 mb-3 font-semibold text-lg">22. Contact Us</h4>
    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>support@zcom.web</b>.</p>
    <p style="margin-top: 5em; font-size: 0.7em;">This <a href="https://policymaker.io/privacy-policy/" target="_blank">Privacy Policy</a> was created for <b>zcom.co</b> by <a href="https://policymaker.io" target="_blank">PolicyMaker.io</a> on 2023-01-26.</p>
    `,
};
...
const PrivacyPage = () => {
  return (
    <Container className="p-4 sm:p-10">
      <HeadTitle title="Privacy Policy" className="pt-4 pb-10" />
